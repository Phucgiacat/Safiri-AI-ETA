...
1. **Continuously estimate shipment ETA throughout the shipment lifecycle while modeling how upstream disruptions propagate into downstream stages.**
...
│
├── notebooks/
│   └── end_to_end_pipeline.ipynb # Main analysis notebook
│
├── src/
...
![Delay Cascade](outputs/figures/delay_cascade.png)

### Model Explainability (SHAP)

![SHAP Summary](outputs/shap/shap_summary_lightgbm_reg.png)
